            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-stretch mb-24">
                    ...
                    <Reveal direction="left" delay={200} className="h-full">
                        <div className="group relative p-10 rounded-[2rem] bg-white/60 backdrop-blur-sm border border-gray-200/50 transition-all duration-500 hover:bg-white hover:shadow-[0_30px_60px_-15px_rgba(59,77,58,0.15)] hover:-translate-y-1 h-full">
                ...
                <div className="mb-32 relative">
                    ...
                    <div className="grid lg:grid-cols-5 gap-10 items-center">
                        ...
                        <div className="lg:col-span-2 flex flex-col items-center group mb-12 lg:mb-0">
                            ...
                            <Reveal delay={300} className="-mt-12 text-center relative z-20">
                        ...
                        <Reveal direction="right" delay={500} className="lg:col-span-3 space-y-6">
